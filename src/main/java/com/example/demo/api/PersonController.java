...
public class PersonController {
    ...
    @PostMapping
    public int insertPerson(@Validated @NonNull @RequestBody Person person){
    ...
    @PutMapping(path = "{id}")
    public int updatePersonById(@PathVariable("id") UUID uuid,@NonNull  @RequestBody Person person){
